...
const float servo_error[4][3] = { {0,0,10}, {10,-5,10}, {0,0,0}, {2,-10,0} }; // JC needed to get servo arm at 90 degrees to the body when set to 90 degrees by program. used in polar_to_servo
